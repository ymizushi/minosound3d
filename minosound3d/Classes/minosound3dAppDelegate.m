...
#import "minosound3dAppDelegate.h"
...
@implementation minosound3dAppDelegate {
	UIWindow* _window;
...
//	_viewController.isOverlayingDeviceCamera = YES;
	...
	CC3Layer* cc3Layer = [minosound3dLayer node];
	
	// Create the customized 3D scene and attach it to the layer.
	// Could also just create this inside the customer layer.
	cc3Layer.cc3Scene = [minosound3dScene scene];
